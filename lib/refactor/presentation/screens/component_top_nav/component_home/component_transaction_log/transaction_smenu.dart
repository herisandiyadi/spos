...
class _TransactionSMenuState extends State<TransactionSMenu>
  ...
  void initState() {
    super.initState();
    getDeviceInfo();
    _transactionHeaderSMController.getTransactionHeaderSMCall();
  }
          ...
          Align(
            ...
            child: Padding(
              ...
              child: OutlinedButton(
                onPressed: () => _transactionHeaderSMController.rebuild(),
            ...
            child: SingleChildScrollView(
              ...
              child: Container(
                ...
                child: ClipRRect(
                  ...
                  child: Obx(() {
                    final state = _transactionHeaderSMController.status.value;

                    if (state.isLoading) return LoaderTable();
                    if (state.isError) {
                      return NetworkExceptionHandling(
                        exception: state.errorMessage ?? '---',
                        refresh: () => _transactionHeaderSMController.rebuild(),
                      );
                    }

                    final smData =
                        _transactionHeaderSMController.transactionSMList;

                    return smData.isEmpty
                        ? Container(
                            width: size.width,
