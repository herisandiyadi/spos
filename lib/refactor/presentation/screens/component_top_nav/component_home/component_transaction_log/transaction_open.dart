...
class TransactionOpen extends StatefulWidget {
  const TransactionOpen({super.key});

  @override
  State<TransactionOpen> createState() => _TransactionOpenState();
}

class _TransactionOpenState extends State<TransactionOpen>
    with AutomaticKeepAliveClientMixin {
  final _homeController = Get.find<HomeController>();
  final _transactionOpenController = Get.find<TransactionOpenController>();
  String ipAddress = '';
  String deviceName = '';
  String staffpin = '';
  ...
  void initState() {
    super.initState();
    getDeviceInfo();
    _transactionOpenController.fetchTransactionOpen();
  }
          ...
          Align(
            ...
            child: Padding(
              ...
              child: OutlinedButton(
                onPressed: () async =>
                    await _transactionOpenController.fetchTransactionOpen(),
            ...
            child: SingleChildScrollView(
              ...
              child: Container(
                ...
                child: ClipRRect(
                  ...
                  child: Obx(() {
                    final state = _transactionOpenController.status.value;

                    if (state.isLoading) return LoaderTable();
                    if (state.isError) return Container();

                    final offlineData =
                        _transactionOpenController.transactionOpen;
