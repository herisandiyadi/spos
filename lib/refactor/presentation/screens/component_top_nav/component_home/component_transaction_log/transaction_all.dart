...
class _TransactionAllState extends State<TransactionAll>
  ...
  void initState() {
    ...
    _transactionAllController.fetchTransactionAll();
    getDeviceInfo();
  }
          ...
          Align(
            ...
            child: Padding(
              ...
              child: OutlinedButton(
                onPressed: () async =>
                    await _transactionAllController.fetchTransactionAll(),
            ...
            child: SingleChildScrollView(
              ...
              child: Container(
                ...
                child: ClipRRect(
                  ...
                  child: Obx(() {
                    final state = _transactionAllController.status.value;

                    if (state.isLoading) return LoaderTable();
                    if (state.isError) return Container();

                    final offlineData =
                        _transactionAllController.transactionAll;
